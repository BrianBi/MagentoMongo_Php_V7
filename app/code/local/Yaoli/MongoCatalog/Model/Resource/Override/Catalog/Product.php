 ...
 */
class Yaoli_MongoCatalog_Model_Resource_Override_Catalog_Product extends Mage_Catalog_Model_Resource_Product
{
     ...
     *
     * @return Yaoli_MongoCore_Model_Resource_Connection_Adapter
     */
     ...
     *
     * @return Yaoli_MongoCatalog_Model_Resource_Override_Catalog_Product Self reference
     */
    protected function _processSaveData($saveData)
    {
        ...
        if (!empty($unsetData)) {
            $collection->updateOne($updateCond, array('$unset' => $unsetData), array('upsert' => true));
        }
     ...
     *
     * @return Yaoli_MongoCore_Model_Resource_Override_Catalog_Product Self reference
     */
     ...
     *
     * @return Yaoli_MongoCore_Model_Resource_Override_Catalog_Product
     */
     ...
     *
     * @return Yaoli_MongoCatalog_Model_Resource_Override_Catalog_Product
     */
